        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('peminjam.index') }}">Data Peminjaman</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pd-10 pd-sm-20 bg-gray-100">
                        <form action="{{ route('peminjam.create') }}" method="post" enctype="multipart/form-data"> 
                            @csrf
                        <div class="row">
                        <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row row-xs align-items-center mg-b-20">
                                                ...
                                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" placeholder="" type="date" name="tanggal_peminjaman" value="{{old('tanggal_peminjaman')}}">
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-20">
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" placeholder="" type="date" name="tanggal_pengembalian" value="{{old('tanggal_pengembalian')}}">
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-20">
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" placeholder="" type="text" name="status_peminjam" value="{{old('status_peminjam')}}">
                                                </div>
                                            </div>
                        ...
                        <a href="{{route('peminjam.index')}}" class="btn btn-secondary pd-x-30 mg-t-5">
